...
import com.example.androidfit.MainActivity;
...
public class SleepFragment extends FragmentActivity {
    public static final String TAG = "SLEEP";
    private static final String AUTH_PENDING = "auth_state_pending";

    public static GoogleApiClient mClient = null;

    private static final ArrayList<Session> sessionsSleep = null;
    private static final ArrayList<SleepData> sleepList = null;
    private static final ArrayList<SleepInfo> sleepInfoList = null;
    private static final Date lastSleepSession = null;
    static DataSource SLEEP_HISTORY = new DataSource.Builder()
            .setDataType(DataType.TYPE_SLEEP_SEGMENT)
            .setType(DataSource.TYPE_DERIVED)
            .setStreamName("estimated_sleep_duration")
    ...
    private static void dumpDataSet(DataSet dataSet) {
        ...
        for (DataPoint dp : dataSet.getDataPoints()) {
            ...
            Log.i(TAG, "\tStart: " + new org.joda.time.DateTime(dp.getStartTime(TimeUnit.MILLISECONDS)));
            Log.i(TAG, "\tEnd: " + new org.joda.time.DateTime(dp.getEndTime(TimeUnit.MILLISECONDS)));
            for (Field field : dp.getDataType().getFields()) {
                if (dp.getOriginalDataSource().getAppPackageName().contains("sleep") && field.getName().contains("duration")) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_delete_data) {
            ...
            Intent intent = new Intent(SleepFragment.this, MainActivity.class);
